              ...
              <div className="row"> 
                  <div className={[styles['campHead'] , 'col-md-3'].join(' ')} style={{backgroundColor: "#e1eeff", height: 525, position: "fixed", top: "0"}}>
                    ...
                    <h5>{this.state.campaign.name}</h5>
                      <Link to={"/campaignOverview/" + this.props.match.params.id_1} className={styles.navLink3}><img src={require('../assets/img/gridblack.png')} style={{marginRight:10, paddingLeft:10}} />Overview</Link>
                      <Link to={"/addMessage/" + this.props.match.params.id_1} className={styles.navLink3}><img src={require('../assets/img/at sign.png')} style={{marginRight:10, paddingLeft:10}} />Daily Message</Link>
                      <Link to={"/messageView/" + this.props.match.params.id_1} className={styles.navLink3}><img src={require('../assets/img/Message.png')} style={{marginRight:10, paddingLeft:10}} />Message</Link>
                      <Link to={"/addEvent/" + this.props.match.params.id_1} className={styles.navLink3}><img src={require('../assets/img/uil_process.png')} style={{marginRight:10, paddingLeft:10}} />Process</Link>
