            ...
            if(this.state.startDate.getMonth() <= this.state.endDate.getMonth()){
                    ...
                    if(this.state.title === ''  && this.state.text === ''){
                        ...
                        if(this.state.startDate.getDate() === this.state.endDate.getDate()){
                            ...
                            axios.post('https://kaimpaigner-cms-backend.herokuapp.com/api/addMailbox/' + this.props.match.params.id, event)
                                .then(res => {
                            ...
                            window.location = '/addMailBox/' + this.props.match.params.id
                        }else{
                            if(this.state.startDate.getDate() < this.state.endDate.getDate()){
                                const event = {
                                    title: this.state.title,
                  ...
                  <div className={styles.divPos4}>
                        <div className="col-md-8">
                            <form onSubmit={this.onSubmit} name="userForm" className="needs-validation" noValidate>
                                <h1 className={styles.h1Style}>Add Mailbox</h1>
                                <br/>
                                ...
                                <div className="form-group"> 
                                    ...
                                    <select className="form-control" value={this.state.addOn} onChange={this.onChangeAddOn} style={{width: "300px", fontSize:12}}>
                                        ...
                                        <option value="Underresed Letter">Underresed Letter</option>
                                        <option value="Free Newspaper">Free Newspaper</option>
                                ...
                                <br/>
                                <button type="submit" className={[styles['btnStyle'] , 'btn btn-primary'].join(' ')} style={{backgroundColor:'#214d8a', borderRadius:0, fontSize:10}}>Add Mailbox</button>
