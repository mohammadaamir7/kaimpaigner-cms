...
export default class addFieldOperation extends Component{
    constructor(props){
        super(props)
            ...
            if(this.state.startDate.getMonth() <= this.state.endDate.getMonth()){
                    ...
                    if(this.state.title === ''  && this.state.text === ''){
                        ...
                        if(this.state.startDate.getDate() === this.state.endDate.getDate()){
                            ...
                            window.location = '/addFieldOperation/' + this.props.match.params.id
                        }else{
                            if(this.state.startDate.getDate() < this.state.endDate.getDate()){
                                const event = {
                                    title: this.state.title,
                  ...
                  <div className={styles.divPos4}>
                        <div className="col-md-8">
                            <form onSubmit={this.onSubmit} name="userForm" className="needs-validation" noValidate>
                                <h1 className={styles.h1Style}>Add Field Operation</h1>
                                <br/>
                                ...
                                <div className="form-group"> 
                                    ...
                                    <select className="form-control" value={this.state.addOn} onChange={this.onChangeAddOn} style={{width: "300px", fontSize:12}}>
                                        ...
                                        <option value="Petetion Collection">Petetion Collection</option>
                                        <option value="Database building">Database building</option>
                                        <option value="Call Centre Operation">Call Centre Operation</option>
                                        <option value="Volunteer Operation">Volunteer Operation</option>
                                ...
                                <br/>
                                <button type="submit" className={[styles['btnStyle'] , 'btn btn-primary'].join(' ')} style={{backgroundColor:'#214d8a', borderRadius:0, fontSize:10}}>Add Operation</button>
