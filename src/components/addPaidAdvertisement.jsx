...
export default class addPaidAdvertisement extends Component{
    constructor(props){
        super(props)
            ...
            if(this.state.startDate.getMonth() <= this.state.endDate.getMonth()){
                    ...
                    if(this.state.title === ''  && this.state.text === ''){
                        ...
                        if(this.state.startDate.getDate() === this.state.endDate.getDate()){
                            ...
                            window.location = '/addPaidAdvertisement/' + this.props.match.params.id
                        }else{
                            if(this.state.startDate.getDate() < this.state.endDate.getDate()){
                                const event = {
                                    title: this.state.title,
                  ...
                  <div className={styles.divPos4}>
                        <div className="col-md-8">
                            <form onSubmit={this.onSubmit} name="userForm" className="needs-validation" noValidate>
                                <h1 className={styles.h1Style}>Add Paid Media Advertisement</h1>
                                <br/>
