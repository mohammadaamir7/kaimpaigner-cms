...
export default class addDigitalAdd extends Component{
    constructor(props){
        super(props)
            ...
            if(this.state.startDate.getMonth() <= this.state.endDate.getMonth()){
                    ...
                    if(this.state.title === ''  && this.state.text === ''){
                        ...
                        if(this.state.startDate.getDate() === this.state.endDate.getDate()){
                            ...
                            axios.post('https://kaimpaigner-cms-backend.herokuapp.com/api/addDigitalAdd/' + this.props.match.params.id, event)
                                .then(res => {
                            ...
                            window.location = '/addDigitalAdd/' + this.props.match.params.id
                        }else{
                            if(this.state.startDate.getDate() < this.state.endDate.getDate()){
                                const event = {
                                    title: this.state.title,
              ...
              <div className="row"> 
                  ...
                  <div className={styles.divPos4}>
                            ...
                            <form onSubmit={this.onSubmit} name="userForm" className="needs-validation" noValidate>
                                <h1 className={styles.h1Style}>Add Digital Adds</h1>
                                <br/>
                                ...
                                <br/>
                                <button type="submit" className={[styles['btnStyle'] , 'btn btn-primary'].join(' ')} style={{backgroundColor:'#214d8a', borderRadius:0, fontSize:10}}>Add Digital ADD</button>
