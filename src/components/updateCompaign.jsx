...
export default class updateCompaign extends Component{
    constructor(props){
        super(props)
    ...
    componentDidMount(){
        ...
        .then(res => {
            ...
            this.setState({description: this.state.campaign.description})
            this.setState({creationDate: new Date(this.state.campaign.creationDate)})
            //this.state.creationDate = this.state.campaign.creationDate
        })
    ...
    render(){
      ...
      <div className="row">
          ...
          <h1 className={styles.h1Style}>Update Campaign</h1>
